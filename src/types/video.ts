...
export const CATEGORY_FALLBACK_THUMBNAILS: Record<string, string> = {
  'Radio & mixtapes': 'https://images.unsplash.com/photo-1503951914875-452162b0f3f1?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Travel & transit': 'https://images.unsplash.com/photo-1544620347-c4fd4a3d5957?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Folk & regional': 'https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Classical & instrumental': 'https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Nostalgia & retro': 'https://images.unsplash.com/photo-1461360370896-922624d12aa1?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Devotional & spiritual': 'https://images.unsplash.com/photo-1519817650390-64a93db51149?auto=format&fit=crop&w=800&q=80&fm=webp',
  'Ambient & mood': 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?auto=format&fit=crop&w=800&q=80&fm=webp',
};
...
export function getEffectiveThumbnailUrl(video: Partial<Video>): string {
  ...
  // Convert Unsplash images to WebP if not already specified
